...
tm Shop::getWorkingTime()
{
	return workingTime;
}

int Shop::getNumberClientDiscount()
{
	return numberClientDiscount;
}
...
void Shop::setIncome(int i)
{
	income = i;
}

void Shop::setWorkingTime(tm workT)
{
	workingTime = workT;
}

void Shop::setNumberClientDiscount(int number)
{
	numberClientDiscount = number;
}

void Shop::setType(string t)
{
	type = t;
}
